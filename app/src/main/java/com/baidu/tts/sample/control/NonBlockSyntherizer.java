...
public class NonBlockSyntherizer extends MySyntherizer {
    ...
    private static NonBlockSyntherizer instance = null;
    public static NonBlockSyntherizer getInstance(Context context, InitConfig initConfig, Handler mainHandler){
        synchronized (NonBlockSyntherizer.class){
            if(instance == null){
                instance = new NonBlockSyntherizer(context,initConfig,mainHandler);
            }
        }
        return instance;
    }
